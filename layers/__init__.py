        ...
        if args.adaptive_id_lambda:
            ...
            if len(id_hist) >= 2:
                ...
                if id_std > metric_std and id_std > 1e-12:
                    ...
                    adaptive_state['id_lambda'] = (
                        args.adaptive_id_alpha * adaptive_state['id_lambda']
                        + (1.0 - args.adaptive_id_alpha) * new_lambda
                    )
                    adaptive_state['id_lambda'] = max(
                        args.adaptive_id_min,
                        min(args.adaptive_id_max, adaptive_state['id_lambda']))
            id_lambda = adaptive_state['id_lambda']
        else:
            id_lambda = args.id_loss_lambda

        id_loss = id_lambda * id_raw
